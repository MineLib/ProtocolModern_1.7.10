...
using ProtocolModern.Data.EntityMetadata;
...
namespace ProtocolModern.Data
{
    ...
    public class EntityMetadataList : IEquatable<EntityMetadataList>
    {
        ...
        public EntityMetadataList(int length = 0) { _entries = new Dictionary<byte, EntityMetadataEntry>(length); }
        ...
        public override int GetHashCode() => _entries.GetHashCode() ^ Count.GetHashCode();
    }
}
